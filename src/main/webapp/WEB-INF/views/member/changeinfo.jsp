  ...
  <div class="modiBack" id="modiBack">
    ...
    <figure class="snip1200">
      ...
      <figcaption>
        ...
        이름은 수정이 불가하며 Email은 <span><button id="veri-btn">정회원인증</button></span>에서 새로 메일인증을 받으셔야 합니다.  </p>
        <div class="heading">
          <h3>개인정보변경</h3>
        </div>
      </figcaption>
...
<script>
 ...
 moveEI.addEventListener("click",function(){
	 location.href="http://localhost:8080/khblind/cert/emailInsert";
 });
</script>
